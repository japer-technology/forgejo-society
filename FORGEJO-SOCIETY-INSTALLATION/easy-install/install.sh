...
echo "  4. Install the runner on the same or another host. Copy"
echo "     install-runner.sh from wherever you obtained this script"
echo "     (your own clone or self-hosted Forgejo mirror), then run:"
echo ""
