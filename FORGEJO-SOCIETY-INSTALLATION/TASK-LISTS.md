...
1. Start in [FORGEJO-SOCIETY-INSTALLATION/README.md](README.md) for guide-first navigation.
...
4. Update this index whenever a new operational checklist is added anywhere under `FORGEJO-SOCIETY-INSTALLATION/`.
