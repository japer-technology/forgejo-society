...
extensions, and a crosswalk to the [Society of Repo](../SOCIETY-OF-REPO/README.md)
specification.
...
The [Society of Repo](../SOCIETY-OF-REPO/README.md) takes those commitments
...
| [12-crosswalk-to-society-of-repo.md](12-crosswalk-to-society-of-repo.md) | How each Minsky concept lands in [SOCIETY-OF-REPO](../SOCIETY-OF-REPO/README.md). |
...
protocol in the [Society of Repo](../SOCIETY-OF-REPO/README.md) is an attempt
...
| **SOR mapping:** | The corresponding construct in [SOCIETY-OF-REPO](../SOCIETY-OF-REPO/README.md). |
