...
1. Start in [FORGEJO/README.md](README.md) for guide-first navigation.
...
4. Update this index whenever a new operational checklist is added anywhere under `FORGEJO/`.
