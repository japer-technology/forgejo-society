...
> A single-page, link-rich description of Forgejo Society, suitable for
> printing as an A1/A2 poster or rendering as a one-page PDF in the
> press-kit asset bundle.

This document is the **canonical text content** of the Forgejo Society
project poster. It is a Markdown source: layout, typography, and
print-ready rendering are downstream concerns that draw their words
from here. Voice rules live in
[`../08-style-guide.md`](../08-style-guide.md); visual rules live in
[`../06-visual-identity.md`](../06-visual-identity.md); the press-kit
context for this poster is described in
...
*A self-hosted, local-first cognitive forge.*
...
<sub>Source: root [`README.md`](../../README.md).</sub>
...
- **Runtime.** Self-hosted Forgejo on owned Ubuntu hardware.
- **Shared Forgejo instances** (e.g. Codeberg) are source mirrors,
  never runtimes.
...
Scaffold. The text content above is drawn from canonical sources and
may be used as-is on a printed poster or in a one-page PDF. A rendered
poster asset (PDF or SVG) is added to
[`../assets/`](../assets/README.md) once produced and approved.
