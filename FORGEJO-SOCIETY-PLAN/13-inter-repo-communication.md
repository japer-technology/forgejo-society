...
- Service Channel Protocol: [`../THE-SOCIETY-OF-REPO/02-protocols/07-service-channel.md`](../THE-SOCIETY-OF-REPO/02-protocols/07-service-channel.md)
- Bridges Protocol: [`../THE-SOCIETY-OF-REPO/02-protocols/18-bridges.md`](../THE-SOCIETY-OF-REPO/02-protocols/18-bridges.md)
- Forgejo Environment Protocol (single-adapter rule): [`../THE-SOCIETY-OF-REPO/02-protocols/15-forgejo-environment.md`](../THE-SOCIETY-OF-REPO/02-protocols/15-forgejo-environment.md)
- Channels registry: [`../THE-SOCIETY-OF-REPO/09-channels/README.md`](../THE-SOCIETY-OF-REPO/09-channels/README.md)
