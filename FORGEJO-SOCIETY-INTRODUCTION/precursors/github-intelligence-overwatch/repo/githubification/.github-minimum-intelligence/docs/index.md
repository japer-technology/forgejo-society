...
| [CONTRIBUTING](../../../githubification-ironclaw/CONTRIBUTING.md) | How to report bugs, suggest features, submit changes, and set up a development environment. |
| [CODE OF CONDUCT](../../../developer-japer-io/CODE_OF_CONDUCT.md) | Community standards, expected behavior, and alignment with the Four Laws. |
| [LICENSE](../../../developer-japer-io/LICENSE.md) | MIT License. |
