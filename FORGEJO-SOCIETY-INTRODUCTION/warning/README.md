...
The [Git hosts with native CI/CD execution capability](#git-hosts-with-native-cicd-execution-capability)
section below surveys which Git hosts expose native CI/CD runners or
agents at all. It is the background table the per-platform documents
draw on when they speak about runners, workflows, and execution.
